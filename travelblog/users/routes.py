...
from travelblog import db, bcrypt
from travelblog.models import User, Post
from travelblog.users.forms import (RegistrationForm, LoginForm, UpdateAccountForm,
                                   RequestResetForm, ResetPasswordForm)
from travelblog.users.utils import save_picture, send_reset_email
...
def reset_token(token):
    ...
    if user is None:
        flask('That is an invalid or expired token', 'warning')
